...
| `jq` | 1.7+ (latest: 1.8.1) | JSON consolidation |
| `yq` | 4.x+ (mikefarah/yq; latest: 4.53.2) | policies.yaml reads. **Ubuntu note:** `apt install yq` installs the WRONG tool (kislyuk/yq, Python-based). Use `snap install yq`. |
